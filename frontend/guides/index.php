...
<html>
<head>
    <title>opensrc.one - Guides</title>
    ...
    <div class="page">
        <div class="home">
            ...
            <div class="page-content">
                <p>
                    Guides and information on tools and services that help you protect your online privacy.
                </p>
            </div>
        </div>
        <hr>
        <div class="node-list">
            <div class="page-content">
                <ul>
                    <li>
                        <span><h2>Guide 1 - Test One</h2></span>
                        <p>This is a test description for the first guide.</p>
                    </li>
                    <li>
                        <span><h2>Guide 2 - Test Two</h2></span>
                        <p>This is a test description for the second guide.</p>
                    </li>
                </ul>
            </div>
        </div>
